...
#include "CardShape.g.hpp"
#include "App.g.hpp"
#include "Player.g.hpp"
#include "PlayingTable.g.hpp"
...
::Windows::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::CreateXamlType(::Platform::String^ typeName)
{
    ...
    if (typeName == L"BlackjackClient.CardShape")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::BlackjackClient::CardShape(); 
            };
        userType->SetIsLocalType();
        return userType;
    }

    if (typeName == L"BlackjackClient.PlayerSpace")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"Windows.UI.Xaml.Controls.UserControl"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::BlackjackClient::PlayerSpace(); 
            };
        userType->SetIsLocalType();
        return userType;
    }

    if (typeName == L"BlackjackClient.PlayingTable")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::BlackjackClient::PlayingTable(); 
            };
        userType->SetIsLocalType();
        return userType;
    }
